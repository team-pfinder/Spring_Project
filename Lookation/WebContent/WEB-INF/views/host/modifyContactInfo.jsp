...
<head>
<meta charset="UTF-8">
<title>modifyContactInfo.jsp</title>
...
<div class="container">
   ...
   <p class="mb-4"> 연락처정보를 수정하세요. <a target="_blank" href="#"></a></p>
	...
	<form style="width: 80%; margin: 120px;" id="inputContactInfo" 
		  action="modifycontactinfo.action?loc_code=${loc_code }" method="post">
	...
	<br><br><br>
		...
		<div id="mainContact">
			...
			<input type="text" class="form-control" id="inputMainContact" name="inputMainContact"
				    ...
				    value="${contactList.loc_main_tel}">
			<span style="font-weight: bold;"></span>
		</div>
