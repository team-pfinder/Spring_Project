							...
							<div class="blog-entry align-self-stretch">
								...
								<div class="text mt-3 text-center">
									<div class="meta mb-2">
										...
										<div>
											<a href="#"><span class="icon-star"></span> 4.1</a>
										</div>
										<div>
											<a href="#"><span class="icon-people"></span> 4</a>
										</div>
										<div>
										...
										<div>
											<a href="#"><span class="icon-won"></span> 60,000~</a>
										</div>
									</div>
									<h3 class="heading">
										<a href="#">개구리랑 놀이동산 파티룸</a>
									</h3>
								</div>
							</div>
						</div>
							...
							<div class="blog-entry align-self-stretch">
								...
								<div class="text mt-3 text-center">
									<div class="meta mb-2">
										...
										<div>
											<a href="#"><span class="icon-star"></span> 4.3</a>
										</div>
										<div>
											<a href="#"><span class="icon-people"></span> 6</a>
										</div>
										<div>
											<a href="#" class="meta-chat"><span class="icon-chat"></span>
												99</a>
										...
										<div>
											<a href="#"><span class="icon-won"></span> 90,000~</a>
										</div>
									</div>
									<h3 class="heading">
										<a href="#">우후죽순</a>
							...
							<div class="blog-entry align-self-stretch">
								...
								<div class="text mt-3 text-center">
									<div class="meta mb-2">
										...
										<div>
											<a href="#"><span class="icon-star"></span> 3.8</a>
										</div>
										<div>
											<a href="#"><span class="icon-people"></span> 8</a>
										</div>
										<div>
											<a href="#" class="meta-chat"><span class="icon-chat"></span>
												20</a>
										...
										<div>
											<a href="#"><span class="icon-won"></span> 190,000~</a>
										</div>
									</div>
									<h3 class="heading">
										<a href="#">길이가 들쭉날쭉하면요</a>
									</h3>
								</div>
							</div>
						</div>
							...
							<div class="blog-entry align-self-stretch">
								...
								<div class="text mt-3 text-center">
									<div class="meta mb-2">
										...
										<div>
											<a href="#"><span class="icon-star"></span> 1.8</a>
										</div>
										<div>
											<a href="#"><span class="icon-people"></span> 100</a>
										</div>
										<div>
											<a href="#" class="meta-chat"><span class="icon-chat"></span>
												123</a>
										...
										<div>
											<a href="#"><span class="icon-won"></span> 1,200,000~</a>
										</div>
									</div>
									<h3 class="heading">
										<a href="#">사탄들의 학교에 루시퍼의 등장이라... 재밌어지겠네</a>
									</h3>
								</div>
							</div>
						</div>
							...
							<div class="blog-entry align-self-stretch">
								...
								<div class="text mt-3 text-center">
									<div class="meta mb-2">
										...
										<div>
											<a href="#"><span class="icon-star"></span> 4.9</a>
										</div>
										<div>
											<a href="#"><span class="icon-people"></span> 1</a>
										</div>
										<div>
											<a href="#" class="meta-chat"><span class="icon-chat"></span>
												5</a>
										...
										<div>
											<a href="#"><span class="icon-won"></span> 10,000~</a>
										</div>
									</div>
									<h3 class="heading">
										<a href="#">개구리 일하러오세요~</a>
							...
							<div class="blog-entry align-self-stretch">
								...
								<div class="text mt-3 text-center">
									<div class="meta mb-2">
										...
										<div>
											<a href="#"><span class="icon-star"></span> 4.4</a>
										</div>
										<div>
											<a href="#"><span class="icon-people"></span> 5</a>
										</div>
										<div>
											<a href="#" class="meta-chat"><span class="icon-chat"></span>
												27</a>
										...
										<div>
											<a href="#"><span class="icon-won"></span> 150,000~</a>
										</div>
									</div>
									<h3 class="heading">
										<a href="#">개구리랑 놀이동산 파티룸 하나를 길쭉하게 쓰면 어떻게 되려나 이렇게 이렇게 이렇게
											이렇게 길어져도?</a>
									</h3>
								</div>
							</div>
