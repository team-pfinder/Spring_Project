							...
							<div class="col-md-12 col-lg-10">
								<div class="row">
									...
									<div class="col-md-4 mb-md-0 mb-4">
										...
										<ul class="list-unstyled">
											<li><a href="termsofservice.action?identify=member" class="py-1 d-block">이용약관</a></li>
											<li><a href="privacy.action?identify=member" class="py-1 d-block">개인정보 보호<br>정책</a></li>
											<li><a href="locmanagement.action?identify=member" class="py-1 d-block">공간관리 정책</a></li>
											<li><a href="refund.action?identify=member" class="py-1 d-block">정산 및 환불 정책</a></li>
										</ul>
									</div>
									<div class="col-md-4 mb-md-0 mb-4">
