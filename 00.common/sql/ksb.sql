...
AS
SELECT P.PACKAGE_CODE AS CODE, AP.APPLY_PACKAGE_CODE AS APPLY_CODE
...
AS
SELECT H.HOST_CODE AS HOST_CODE, LBIF.LOC_NAME AS LOC_NAME
     , L.LOC_REG_DATE AS LOC_REG_DATE, T.THUMBNAIL_URL AS THUMBNAIL_URL
     , NVL(IT.INSPECT_TYPE, '검수대기') AS INSPACT_TYPE
...
SELECT LOC_NAME, LOC_REG_DATE, THUMBNAIL_URL, INSPACT_TYPE
FROM LOC_LIST_VIEW
