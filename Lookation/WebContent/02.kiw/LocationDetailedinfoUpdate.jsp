...
<div class="container">
   ...
   <p class="mb-4"> 상세정보를 수정하세요. <a target="_blank" href="#">이전으로</a>.</p>
...
<br><br><br>
	...
	<div id="MinAvailablePeople">
		...
		<input type="text" required="required" class="form-control"
				placeholder="최소 수용인원을 수정하세요.[최소 1명 이상 ~ 최대 10명 이하]"
...
<br><br><br>
	...
	<!-- 3. 최대 수용인원 -->
		...
		<div id="MaxAvailablePeople">
			...
			<br><br>
			<input type="text" required="required" class="form-control"
					placeholder="최대 수용인원을 수정하세요.[최소 수용인원 이상, 최대 30명 이하]"
...
<!-- 다음 버튼(공통) : 다음 수정페이지로 넘어가고, DB에 저장된다.
					   (필수항목을 입력하지 않았을 경우,
