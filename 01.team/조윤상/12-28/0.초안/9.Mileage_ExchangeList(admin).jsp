...
<head>
<meta charset="UTF-8">
<title>9.Mileage_ExchangeList(admin).jsp</title>
...
<div id='bbsList_list'>
	<div id="title">
		<dl>
			...
			<dt class="date_apply">환전신청일자</dt>
			<dt class="processedOrNot">환전처리</dt>
	...
	<div id="lists"> 
		...
		<dl>
			...
			<dd class="date_processed"><button>처리</button></dd>
		</dl>
	</div><!-- #lists -->
...
참고이미지<a href="<%=cp1 %>/images/Mileage_ExchangeList(admin).png">그림</a>
