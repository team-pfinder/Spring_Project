...
public class HostBlackManager
{
	...
	public String hostBlackManager(Model model)
	{
	...
	public String viewReportDetailsHost(Model model, String host_code)
	{
		IHostBlackManagerDAO dao = sqlSession.getMapper(IHostBlackManagerDAO.class);
	...
	public String setBlackHost(Model model, String host_code)
	{
		IHostBlackManagerDAO dao = sqlSession.getMapper(IHostBlackManagerDAO.class);
