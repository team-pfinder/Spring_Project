...
<head>
<meta charset="UTF-8">
<title>modifyDetailInfo.jsp</title>
      ...
      <div class="container">
         <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
               ...
               <h1 class="mb-0 bread">상세정보 수정</h1>
            </div>
         </div>
      </div>
   </section>
...
<div class="container">
   ...
   <!-- Page Heading -->
   <h1 class="mb-2 text-gray-800">상세정보 수정</h1>
   <p class="mb-4"> 상세정보를 수정하세요. <a target="_blank" href="#"></a></p>
      ...
      <div class="card shadow mb-4">
         <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-default">상세정보 수정</h6>
         </div>


	<!-- form start --------------------------------------------->
	<form style="width: 80%; margin: 120px;" id="inputDetailInfo"  enctype="multipart/form-data"
		  action="modifydetailinfo.action?loc_code=${loc_code }" method="post">	
	...
	<br><br><br>
		...
		<div id="minPeople">
			...
			<input type="text" class="form-control"
					...
					value="${detailInfoList.min_people }">
					<!-- onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" -->
	...
	<br><br><br>
		...
		<div id="maxPeople">
			...
			<input type="text" class="form-control"
					...
					onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
					value="${detailInfoList.max_people }">
					<!-- onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" -->
					<!-- oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); -->
