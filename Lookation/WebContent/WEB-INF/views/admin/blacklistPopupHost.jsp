			...
			<div class="col-md-12">
				...
				<div class="div-table">
					<div class="div-table-body">
						<div class="div-row">
							<div class="div-col font-weight-bold">회원코드</div>
							<div class="div-col">${host_code }</div>
							<input type="hidden" value=${host_email } name="host_email">
						</div>
						<div class="div-row">
							<div class="div-col font-weight-bold vertical-top"><label for="regReason">등록사유</label></div>
							<div class="div-col">
								<textarea rows="5" cols="10" class="form-control form-control-sm" id="regReason" 
								name="host_blacklist_reason"
