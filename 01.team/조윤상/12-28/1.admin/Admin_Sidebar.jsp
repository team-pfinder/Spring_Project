		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapsePages2" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="login.html">신고처리</a> <a
						class="collapse-item" href="register.html">신고내역</a> <a
						class="collapse-item" href="register.html">블라인드 관리</a> <a
						class="collapse-item" href="login.html">블랙리스트 관리</a>
				</div>
			</div></li>
