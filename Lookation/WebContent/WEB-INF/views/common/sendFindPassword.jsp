...
<body class="back-default">
	...
	<div class="head">
		<c:if test="${identify eq 'host' }">
			<h1 style="font-weight:1000;">호스트 비밀번호 변경 인증</h1>
		</c:if>
		<c:if test="${identify eq 'member' }">
			<h1 style="font-weight:1000;">이용자 비밀번호 변경 인증</h1>
		</c:if>
	</div>

	<div class = "container">
		<div class = "confirmBox">			
			<p><span>${email }</span> 로 비밀번호 변경 링크를 보내드렸습니다.</p> 
			<p>이메일의 링크를 클릭하시면 비밀번호를 변경하실 수 있습니다.</p> 
