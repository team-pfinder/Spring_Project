...
AS
SELECT A.BOOK_CODE AS BOOK_CODE, A.MEMBER_CODE AS MEMBER_CODE, A.APPLY_PACKAGE_CODE 
AS APPLY_PACKAGE_CODE, A.LOC_CODE, A.APPLY_DATE, A.BOOK_DATE, A.PACKAGE_CODE,
A.PACKAGE_NAME
, A.PACKAGE_START, A.PACKAGE_END, A.BOOK_HOUR, A.HOST_CANCEL, A.MEMBER_CANCEL, A.REFUND
,A.LOC_NAME, A.ACTUAL_BOOKER, A.ACTUAL_BOOKER_TEL
, A.BOOK_PEOPLE, A.BOOK_REQ, A.PACKAGE_PRICE
, A.BIZ_NAME, A.BIZ_CEO, A.BIZ_LICENSE_NUMBER
, A.MEMBER_CANCEL_REASON, A.HOST_CANCEL_REASON
, A.MEMBER_EMAIL, A.LOC_ADDR, A.LOC_DETAIL_ADDR
,A.MEMBER_NICKNAME
...
, (SELECT COUNT(*) FROM BOOK_LIST B WHERE B.APPLY_PACKAGE_CODE = AP.APPLY_PACKAGE_CODE) AS COUNT
FROM PACKAGE P
JOIN PACKAGE_FORM PF
ON P.PACKAGE_FORM_CODE = PF.PACKAGE_FORM_CODE
    JOIN APPLY_PACKAGE AP
