...
<br><br><br>
	...
	<div id="locationBusinessRegNum">
		...
		<br><br>
			<input type="text" required="required" id="locationBusinessRegNum1"
				style="width:100px;">
			-
			<input type="text" required="required" id="locationBusinessRegNum2"
				style="width:100px;">
			-
			<input type="text" required="required" id="locationBusinessRegNum3"
				style="width:100px;">
...
<br><br><br>
	...
	<div id="locationBusinessType">
		...
		<br><br>
			<input required="required" type="radio" name="locationBusinessType" value="간이과세자">간이과세자
			<input required="required" type="radio" name="locationBusinessType" value="일반과세자">일반과세자
			<input required="required" type="radio" name="locationBusinessType" value="법인사업자">법인사업자
			<input required="required" type="radio" name="locationBusinessType" value="면세사업자">면세사업자
			<input required="required" type="radio" name="locationBusinessType" value="기타">기타
	</div>
...
<br><br><br>
	...
	<div id="locationBusinessAddr">
		...
		<br>
		<input type="button" class="form-control" name="locationBusinessAddrInsert" value="주소 등록">
		<!-- 주소등록 버튼클릭 
			 → 주소등록창이라는 새 페이지 등장 
			 →  텍스트로 주소검색 → 검색버튼 클릭 
		...
		<br><br>
		<input type="text" class="form-control" required="required" name="locationBusinessDetailedAddr">
	</div>
