	...
	<div class="container">
		...
		<div class="chatBody">
			...
			<div class="message-left">
				...
				<br>
				<div class="message-timestamp-left">11:00</div>
			</div>

			<div class="message-right">
				<p class="message-content">9999시요</p>
				<br>
				<div class="message-timestamp-right">11:01</div>
			</div>

			<div class="message-left">
				<p class="message-content">네, 비밀번호는 486입니다.</p>
				<br>
				<div class="message-timestamp-left">11:02</div>
			</div>

			<div class="message-right">
				<p class="message-content">네네네</p>
				<br>
				<div class="message-timestamp-right">11:05</div>
			</div>
