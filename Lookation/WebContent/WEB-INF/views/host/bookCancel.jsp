...
<body class="back-default">
	<div class="container">
		...
		<form action="hostcancel.action" method="post" id="cancelForm">
		<div class="row">
				...
				<div class="w-100 text-center p-2">
					...
					<div class="text-small">
						<c:if test="${cancel.days >= 7}">
							<div>예약 가격의 전액인 <span class="text-primary">${cancel.package_price }</span>원이 마일리지로 환불됩니다.</div>
						</c:if>
