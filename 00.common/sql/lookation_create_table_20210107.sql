...
COMMENT ON COLUMN LOAD_REG.MEMBER_BANK_NUMBER IS '계좌번호'
;
...
ALTER TABLE LOAD_REG
    ADD CONSTRAINT FK_LOAD_REG_MEMBER_BANK_NUMBER FOREIGN KEY (MEMBER_BANK_NUMBER)
...
COMMENT ON COLUMN MEMBER_EXCHANGE_LIST.MEMBER_BANK_NUMBER IS '계좌번호'
;
...
ALTER TABLE MEMBER_EXCHANGE_LIST
    ADD CONSTRAINT FK_MEMBER_EXCHANGE_LIST_MEMBER FOREIGN KEY (MEMBER_BANK_NUMBER)
        REFERENCES MEMBER_BANK_INFO (MEMBER_BANK_NUMBER)
;
...
COMMENT ON COLUMN HOST_EXCHANGE_LIST.MEMBER_BANK_NUMBER IS '계좌번호'
;
...
ALTER TABLE HOST_EXCHANGE_LIST
    ADD CONSTRAINT FK_HOST_EXCHANGE_LIST_MEMBER_B FOREIGN KEY (MEMBER_BANK_NUMBER)
