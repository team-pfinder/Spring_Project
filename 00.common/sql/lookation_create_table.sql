...
COMMENT ON COLUMN HOST_EXCHANGE_LIST.HOST_BANK_NUMBER IS '계좌번호'
;
...
ALTER TABLE HOST_EXCHANGE_LIST
    ADD CONSTRAINT FK_HOST_EXCHANGE_LIST_MEMBER_B FOREIGN KEY (HOST_BANK_NUMBER)
...
ALTER TABLE NOTICE_IMG
    ADD CONSTRAINT FK_NOTICE_IMG_NOTICE_CODE FOREIGN KEY (NOTICE_CODE)
